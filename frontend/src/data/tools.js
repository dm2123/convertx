...
const tools = [
  ...
  { id: 10, name: "OCR PDF", slug: "ocr-pdf", category: "PDF", description: "Extract text from scanned documents using OCR.", icon: "Search", implemented: true, formats: [".pdf"] },
  ...
  { id: 12, name: "PDF Annotator", slug: "pdf-annotator", category: "PDF", description: "Add annotations, highlights and notes to PDF.", icon: "PenTool", implemented: true, formats: [".pdf"] },
  ...
  { id: 18, name: "PDF Form Filler", slug: "pdf-form-filler", category: "PDF", description: "Fill out PDF forms quickly and easily.", icon: "FormInput", implemented: true, formats: [".pdf"] },
  { id: 19, name: "PDF Forms", slug: "pdf-forms", category: "PDF", description: "Create and manage interactive PDF forms.", icon: "FileCheck", implemented: true, formats: [".pdf"] },
  { id: 20, name: "Share PDF", slug: "share-pdf", category: "PDF", description: "Share your PDF documents securely online.", icon: "Share2", implemented: true, formats: [".pdf"] },
  { id: 21, name: "Sign PDF", slug: "sign-pdf", category: "PDF", description: "Add digital signatures to your PDF documents.", icon: "Pen", implemented: true, formats: [".pdf"] },
  { id: 22, name: "Request Signatures", slug: "request-signatures", category: "PDF", description: "Request digital signatures from others.", icon: "PenLine", implemented: true, formats: [".pdf"] },
  ...
  { id: 30, name: "Translate PDF", slug: "translate-pdf", category: "AI", description: "Translate PDF documents to any language.", icon: "Languages", implemented: true, formats: [".pdf"] },
  ...
  { id: 40, name: "PDF to POWERPOINT", slug: "pdf-to-powerpoint", category: "Convert", description: "Convert PDF to PowerPoint presentations.", icon: "Presentation", implemented: true, formats: [".pdf"] },
  { id: 41, name: "PDF to EXCEL", slug: "pdf-to-excel", category: "Convert", description: "Convert PDF tables to Excel spreadsheets.", icon: "FileSpreadsheet", implemented: true, formats: [".pdf"] },
  ...
  { id: 53, name: "HWP to PDF", slug: "hwp-to-pdf", category: "Convert", description: "Convert Hancom HWP documents to PDF.", icon: "FileText", implemented: true, formats: [".hwp"] },
  ...
  { id: 55, name: "ZIP to PDF", slug: "zip-to-pdf", category: "Convert", description: "Convert ZIP archive contents to PDF.", icon: "File", implemented: true, formats: [".zip"] },
  ...
  { id: 57, name: "Pages to PDF", slug: "pages-to-pdf", category: "Convert", description: "Convert Apple Pages documents to PDF.", icon: "FileText", implemented: true, formats: [".pages"] },
  ...
  { id: 61, name: "PDF to PPT", slug: "pdf-to-ppt", category: "Convert", description: "Convert PDF to PowerPoint presentations.", icon: "Presentation", implemented: true, formats: [".pdf"] },

...
const DOWNLOADS = [
  ...
  },
  {
    os: 'Android',
    icon: Smartphone,
    desc: 'Android 7+ ke liye APK. ConvertX app phone mein install karo - saare 82 tools mobile par.',
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            saare 82 tools ab desktop app aur mobile app ke roop mein bhi available hain.
